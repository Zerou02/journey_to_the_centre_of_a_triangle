...
func (this *AnimSideCentroid) Draw() {
	...
	if this.movToMpAnim.GetValue() >= glm.Epsilon {
...
func (this *AnimSideCentroid) IsFinished() bool {
	return this.radiusAnim.IsFinished()
}
...
func newCentroidAnim(tri *Tri, animDur float32) CentroidAnim {
	var machine = newStateMachine()
	var side0 = newAnimSideCentroid(tri.Points[0], tri.Points[1], tri.Points[2], tri.Ctx, animDur)
	var side1 = newAnimSideCentroid(tri.Points[1], tri.Points[0], tri.Points[2], tri.Ctx, animDur)
	var side2 = newAnimSideCentroid(tri.Points[2], tri.Points[0], tri.Points[1], tri.Ctx, animDur)
